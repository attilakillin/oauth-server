 ...
 *
 * [ApiException]s thrown in any controller get processed by this handler,
 * which creates and sends meaningful JSON error messages to the client.
 *
 * @see ApiException
 */
@ControllerAdvice
class ApiExceptionHandler : ResponseEntityExceptionHandler() {
     ...
     *
     * Returns a [ResponseEntity] with the status and optionally with the error message
